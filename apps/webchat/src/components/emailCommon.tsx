...
export function emailProgressLabel(state: string | undefined, text: Copy) {
  ...
  switch (state) {
    ...
    case "pending": case "queued": case "retry": case "retrying": case "waiting": return text.email.waiting;
    case "stale": case "refresh_pending": return text.email.refreshPending;
    case "paused": case "disabled": case "paused_binding_changed": case "binding_changed": return text.email.paused;
