...
export const dictionaries = {
  en: {
    ...
    chat: {
      ...
      sendReview: "Review external message",
      ...
      fileFallback: "Sent as a file",
      deliverySent: "Message sent",
      deliveryPartial: "Some parts were sent",
      deliveryFailed: "Message failed",
      deliveryUnknown: "Delivery outcome unknown",
      retryDelivery: "Retry failed parts",
      recipientRequired: "Choose an exact recipient.",
      contentRequired: "Add text or an attachment.",
      partUnsupported: "The selected recipient cannot accept every part.",
      tooManyParts: "The message has too many parts.",
      payloadTooLarge: "The message exceeds the recipient limit."
    },
    auth: {
  ...
  zh: {
    ...
    chat: {
      ...
      moveEarlier: "向前移动",
      moveLater: "向后移动",
      fileFallback: "将作为文件发送",
      deliverySent: "消息已发送",
      deliveryPartial: "部分内容已发送",
      deliveryFailed: "消息发送失败",
      deliveryUnknown: "发送结果未知",
      retryDelivery: "重试失败内容",
      recipientRequired: "请选择一个精确收件人。",
      contentRequired: "请输入文字或添加附件。",
      partUnsupported: "所选收件人无法接收全部内容。",
      tooManyParts: "消息 Part 数量过多。",
      payloadTooLarge: "消息超过收件人限制。"
    },
    auth: {
      gatewayToken: "Gateway token",
