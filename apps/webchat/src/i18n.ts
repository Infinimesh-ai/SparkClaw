...
export const dictionaries = {
  en: {
    ...
    chat: {
      ...
      deliveryHistory: "Message history",
      receivedFrom: "Received from",
      sentTo: "Sent to",
      noDeliveryHistory: "No external messages yet.",
    ...
    settings: {
      ...
      reminderScope: "Allow reminders",
      messageScope: "Allow ordinary messages",
  ...
  zh: {
    ...
    chat: {
      ...
      deliveryHistory: "消息记录",
      receivedFrom: "接收自",
      sentTo: "发送至",
      noDeliveryHistory: "暂无第三方消息。",
      deliverySent: "消息已发送",
    ...
    settings: {
      ...
      reminderScope: "允许发送提醒",
      messageScope: "允许发送普通消息",
