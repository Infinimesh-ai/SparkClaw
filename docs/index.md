...
| [DOCX editing optimization](docx-editing-optimization.md) | Proposed hardening for DOCX style verification, evidence binding, run preservation, coverage, decision projection, and evals |
