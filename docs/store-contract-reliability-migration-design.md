...
> Status: draft staged roadmap, 2026-08-19. This document authorizes no runtime
> change. Each linked design and each implementation result requires a separate
> recorded review decision before the next Store stage starts.
