...
| Integrated Credential/Connector implementation | `1d3fc26` | `GO` | Durable binding identity, pending/active/revoking barriers, live Seal/Open/Delete/AbortSeal callers, restart recovery, legacy cleanup compatibility, missing-token fail-closed behavior, and public redaction are complete; full Go and focused race gates are green | Context-isolated gatekeeper / 2026-08-21 |
