...
contracts. Approval now has a positive isolation assertion. Each remaining
owning repository wave must replace its defect-evidence cell with an isolation
assertion.
