...
| LocalMind tasks | Configured endpoint identity, fixed contract revision, task ID, state version, and internally generated idempotency key | None until a LocalMind Workflow is planned; direct tool results remain bounded untrusted data |
