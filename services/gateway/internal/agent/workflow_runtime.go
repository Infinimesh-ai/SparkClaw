...
func materializedWorkflowResourceKind(kind string) bool {
	...
	case "query", "location", "path", "weather_payload", "url", "browser_tab", "browser_page", "browser_snapshot",
		"browser_before_snapshot", "browser_after_snapshot", "browser_result_url", "public_target_url", "browser_click", "browser_draft", "schedule", "schedule_patch", "localmind_task", "email_admission":
		return true
	default:
		return false
	}
