...
const sourceSummaryPromptVersion = "email-source-summaries-v1"

func (s *Service) buildSourceSummary(ctx context.Context, job app.EmailJob) (AnalysisInput, []string, int64, error) {
	input := AnalysisInput{PolicyVersion: sourceSummaryPromptVersion, OutputLanguage: "source", Kind: job.Kind, TargetID: job.TargetID, Evidence: []Evidence{}, Candidates: []AnalysisCandidate{}, MissingContext: []string{}}
