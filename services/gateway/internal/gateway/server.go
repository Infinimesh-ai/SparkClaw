...
func (s *Server) routes() {
	...
	s.mux.HandleFunc("POST /api/jingsi/v0/messages/stream", s.postJingSiMessageStream)
	s.mux.HandleFunc("GET /api/jingsi/v0/client-events/head", s.headJingSiEvents)
	s.mux.HandleFunc("GET /api/jingsi/v0/client-events", s.listJingSiEvents)
	s.mux.HandleFunc("GET /api/jingsi/v0/client-events/stream", s.streamJingSiEvents)
