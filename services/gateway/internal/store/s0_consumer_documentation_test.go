...
var s0ProductionConsumerComposites = map[string]string{
	...
	"gateway.Server":                                "ISCPOnboarding + Owner + Client + Connector + Session + Conversation + Run + Approval + Audit + Evaluation + ArtifactMetadata + Memory + Schedule + PassiveNotification + DeliveryRecord + ExternalChat + MCP",
	...
	"telegram.Dispatcher":                           "Owner + Connector + Session + Conversation + Run + Approval + Audit + ArtifactMetadata + Schedule + DeliveryRecord + ExternalChat + MCP",
	...
	"toolhub.ToolHub":                               "Session + Run + Approval + Audit + ArtifactMetadata + Memory + Schedule + Connector + ExternalChat + MCP",
	"weixin.Dispatcher":                             "Owner + Connector + Session + Conversation + Run + Approval + Audit + ArtifactMetadata + Schedule + DeliveryRecord + ExternalChat + MCP",
	"weixin.Syncer":                                 "Connector + Session + ArtifactMetadata + Audit + DeliveryRecord + ExternalChat + MCP",
	...
	"messagecontrol.EndpointRegistry":               "Session + Connector + ExternalChat + MCP",
	"messagecontrol.ScheduleRegistry":               "Schedule + Session + Connector + ExternalChat + MCP",
