...
type EmailRepository interface {
	...
	PublishEmailClassification(context.Context, EmailClassificationCommand) (app.EmailMail, error)
	OverrideEmailClassification(context.Context, EmailClassificationOverride) (app.EmailMail, error)
	PurgeEmailCaptures(context.Context, EmailCapturePurgeCommand) (EmailCapturePurgeResult, error)
	ScanEmailCaptures(context.Context, EmailCaptureScan) ([]app.EmailCaptureVersion, error)
	AdoptEmailCapture(context.Context, EmailCaptureAdoption) (app.EmailMail, error)
	UpdateEmailSenderRule(context.Context, EmailSenderRuleCommand) (app.EmailSenderRule, error)
	ListEmailSenderRules(context.Context, EmailQuery) ([]app.EmailSenderRule, error)
	GetEmailThread(context.Context, string, string) (app.EmailProviderThread, bool, error)
	BindEmailMailbox(context.Context, EmailBindCommand) (app.EmailMailbox, error)
	PauseEmailMailbox(context.Context, EmailPauseCommand) (app.EmailMailbox, error)
	...
	BeginEmailSync(context.Context, EmailSyncBeginCommand) (EmailSyncCheckpoint, error)
	CommitEmailSync(context.Context, EmailSyncCommitCommand) (EmailSyncCommitResult, error)
	ReportEmailSourceFailure(context.Context, EmailSourceFailureCommand) (app.EmailMail, error)
	ListEmailSyncWarnings(context.Context, EmailQuery) (EmailSyncWarningPage, error)
	...
	PublishEmailConcern(context.Context, EmailConcernCommand) (app.EmailAssignmentConcern, error)
	PublishEmailSummary(context.Context, EmailSummaryCommand) (app.EmailSummary, error)
	MarkEmailMailsViewed(context.Context, EmailViewedCommand) ([]app.EmailViewReceipt, error)
	ListEmailMails(context.Context, EmailQuery) (EmailMailPage, error)
	...
	FindEmailCandidates(context.Context, EmailCandidateQuery) (EmailCandidateSet, error)
	GetEmailAnalysisTarget(context.Context, string, string, string) (app.EmailAnalysisTarget, bool, error)
	ListEmailConcerns(context.Context, EmailQuery) ([]app.EmailAssignmentConcern, error)
	ListEmailJobs(context.Context, EmailQuery) ([]app.EmailJob, error)
	ListEmailThreads(context.Context, EmailQuery) ([]app.EmailProviderThread, error)
	ListEmailSyncRuns(context.Context, EmailQuery) ([]app.EmailSyncRun, error)
	ReconcileEmailCommand(context.Context, string, string) (EmailCommandReceipt, bool, error)
}

type EmailPresentationRepository interface {
	ReadEmailPresentations(context.Context, EmailPresentationQuery) ([]app.EmailLocalizedPresentation, error)
	EnsureEmailPresentations(context.Context, EmailPresentationCommand) ([]app.EmailLocalizedPresentation, error)
	GetEmailPresentation(context.Context, string, string) (app.EmailLocalizedPresentation, bool, error)
	PublishEmailPresentation(context.Context, EmailPresentationPublish) (app.EmailLocalizedPresentation, error)
}
