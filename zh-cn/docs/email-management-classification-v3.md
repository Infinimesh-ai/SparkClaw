...
状态：2026-09-10 更新，**仅调查与设计，未实施、未部署**。本文根据用户后续讨论修订，作为[分析与处理设计](email-management-analysis-v2.md)的下一版方案；与旧设计冲突时，以本文为后续实施依据，不代表当前运行行为。此前过早实现已撤回，analysis-v2 已部署功能不在撤回范围。
