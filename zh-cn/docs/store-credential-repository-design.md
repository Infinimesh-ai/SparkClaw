...
| Integrated Credential/Connector implementation | `1d3fc26` | `GO` | durable binding identity、pending/active/revoking barrier、live Seal/Open/Delete/AbortSeal caller、restart recovery、legacy cleanup compatibility、missing-token fail-closed 行为及公共脱敏均已完成；完整 Go 与聚焦 race gate 均通过 | Context-isolated gatekeeper / 2026-08-21 |
